...
$html = '
			...
			<div class="conten">
				<span style="font-size:15px"><u><b>SURAT KETERANGAN DOMISILI</b></u></span><br>
			...
			<div class="isi" style="padding-top: 20px;padding-left: 30px;">
				<span >
					<p style="padding-left: 30px;">
					 	Surat Keterangan ini diberikan pada yang bersangkutan untuk dijadikan Keterangan 
					</p>
					<p style="padding-top: -10px;">
						seperlunya, mengingat KTP yang bersangkutan masih dalam proses penerbitan. 
					</p>
					<p style="padding-left: 30px;">
			...
			<div style="padding-top: 100px;padding-left: 10px;font-size: 10px;">
				<p>•	<b>Surat Keterangan ini <u>berlaku hanya
						untuk selama 3 bulan </u></b> 
				</p>
			</div>
...
$mpdf->use_kwt = true;  
$mpdf->AddPage('P');
$mpdf->SetTitle("SKD_".$nama);
$mpdf->WriteHTML($html);
$mpdf->Output("SKD: ".$nama, 'I');
